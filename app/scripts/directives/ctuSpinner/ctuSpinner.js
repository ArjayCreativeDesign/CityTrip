/**
 * Created by RobertMesschendorp on 19/11/16.
 */
(function () {
    cityTripApp.directive('ctuSpinner', function () {
        return {
            restrict: 'E',
            replace: true,
            scope: {},
            templateUrl: 'app/scripts/directives/ctuSpinner/ctuSpinner.html',
            css: 'app/scripts/directives/ctuSpinner/ctuSpinner.css',
            link: function () {
