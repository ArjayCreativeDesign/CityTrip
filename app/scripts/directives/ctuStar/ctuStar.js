(function () {
    cityTripApp.directive('ctuStar', function(databaseService, flickrService, Page) {
        return {
            restrict: 'E',
            replace: true,
            scope: {
            ...
            templateUrl: 'app/scripts/directives/ctuStar/ctuStar.html',
            css: 'app/scripts/directives/ctuStar/ctuStar.css',
            link: function() {
            ...
            controller: function ($scope, $rootScope, $timeout, $state) {
                ...
                var photoId = [ ];
                $scope.delayedHideAnimation = false;
                ...
                self.init = function () {
                  $timeout(function () {
                      $scope.delayedHideAnimation = true;
                  },200);
                  ...
                  $timeout(function () {
                    ...
                    (function() {
                        ...
                        canvas.width = BOOK_WIDTH + ( CANVAS_PADDING * 1.4 );
                        canvas.height = BOOK_HEIGHT + ( CANVAS_PADDING * 1.4 );
